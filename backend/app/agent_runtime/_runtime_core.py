"""Private Stage 1 loop core retained for the canonical fail-closed runtime.

Do not import this module outside ``backend.app.agent_runtime.runtime``.  The
public runtime is the hardened wrapper in ``runtime.py``.
"""
