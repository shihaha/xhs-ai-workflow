...
Task 3: implementation complete; independent review pending. Generated bytes now persist only as server-named managed `output_image` materials after a durable cleanup reservation. Material, generated provenance, cleanup cancellation, media run and reserved job succeed together, with exact commit-ack proof and retained cleanup on uncertain failure. Visual assessments are durable, sealed advisory artifacts bound to the exact run/revision/material bytes and physical identities; reads fail closed on content, file or assessment drift and never change review/content approval state. Latest focused verification: 12 passed. Media + content regression: 345 passed. Full backend regression: 1351 passed, 2 guarded live skips. Live Bailian remains not_run.
